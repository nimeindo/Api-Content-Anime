...
$config['mongo']['use_collection_recomendation_anime'] = env('DB_COLLECTIONS_RECOMENDATION_ANIME', 'contents');
$config['mongo']['use_collection_top_anime'] = env('DB_COLLECTIONS_TOP_ANIME', 'contents');
$config['mongo']['use_collection_slider_anime'] = env('DB_COLLECTIONS_SLIDER_ANIME', 'contents');
